export const translations = {
  en: {
    ...
    sourcing: "Market research & competitive intelligence",
    qualityControl: "B2B client acquisition strategies",
    logisticsTransport: "International market entry",
    exclusiveCatalog: "Strategic partnerships & distribution networks",
    ...
    // Agency Features - Version anglaise
  ...
  fr: {
    ...
    sourcing: "Études de marché & veille concurrentielle",
    qualityControl: "Stratégies d'acquisition B2B",
    logisticsTransport: "Ouverture de marchés internationaux",
    exclusiveCatalog: "Partenariats stratégiques & distribution",
    ...
    // Agency Features - Version française
