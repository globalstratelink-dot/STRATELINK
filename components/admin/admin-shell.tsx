...
export function AdminShell({ children }: AdminShellProps) {
  ...
  return (
    ...
    <div className="h-[100dvh] overflow-hidden bg-[#0a1020] text-white flex flex-col lg:flex-row">

      <AdminSidebar onLogout={logout} />

      <main className="flex-1 min-w-0 min-h-0 overflow-y-auto overscroll-contain">{children}</main>
