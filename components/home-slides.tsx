...
export function HomeSlides() {
  ...
  // Détection responsive côté client (évite l'usage direct de window en SSR)
  useEffect(() => {
    const onResize = () => {
      setIsMobileViewport(typeof window !== 'undefined' ? window.innerWidth < 768 : false)
    }
    onResize()
    ...
    <div className="min-h-screen bg-navy">
      ...
      <section className="py-20 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          {/* Liste simple des 4 carrières */}
          <motion.ul
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.5 }}
            viewport={{ once: true }}
            className="max-w-3xl mx-auto space-y-4 text-white text-lg md:text-xl"
          >
              ...
              Développement Commercial
                    ...
                    <li className="flex items-center">
                      <span className="w-2 h-2 bg-copper rounded-full mr-3"></span>
              Création de Marque et Branding
                    </li>
                    <li className="flex items-center">
                      <span className="w-2 h-2 bg-copper rounded-full mr-3"></span>
              International Sourcing Import / Export
                    ...
                    <li className="flex items-center">
                      <span className="w-2 h-2 bg-copper rounded-full mr-3"></span>
              Digital Solutions : API and SAas
                    </li>
          </motion.ul>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-4 md:gap-8">
              ...
              {/* Groupe de logos */}
            <motion.div
                key={isMobileViewport ? currentMobileIndex : currentGroupIndex}
              initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
