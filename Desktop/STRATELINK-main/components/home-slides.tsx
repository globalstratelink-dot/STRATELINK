  ...
  useEffect(() => {
    ...
    if (!existingScript) {
      ...
      script.onerror = () => {
        ...
        // Afficher le fallback si le script ne se charge pas
    ...
    const initWidget = setTimeout(() => {
      if (typeof window !== 'undefined' && (window as any).Calendly) {
        ...
        widgets.forEach(widget => {
          if (!widget.hasAttribute('data-calendly-initialized')) {
            try {
              ...
              console.error('Erreur initialisation Calendly:', error)
        ...
        console.warn('Calendly API non disponible')
        // Afficher le fallback si Calendly n'est pas disponible
        const fallback = document.getElementById('calendly-fallback')
        if (fallback) {
          fallback.classList.remove('hidden')
          fallback.classList.add('block')
            ...
            >
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-300">{t('rapidReliableDeploymentDesc')}</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-300">{t('turnkeySolutionsDesc')}</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-300">{t('privilegedMarketAccessDesc')}</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-300">{t('customerAcquisitionRetentionDesc')}</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <div className="hidden" id="calendly-fallback">
              <div className="bg-white/10 backdrop-blur-sm border border-copper/20 rounded-2xl p-8 text-center">
                <h3 className="text-2xl font-bold text-white mb-4">Planifier un rendez-vous</h3>
                <p className="text-gray-300 mb-6">Contactez-nous directement pour planifier votre consultation :</p>
                <div className="space-y-4">
                  <a 
                    href="https://calendly.com/stratelink" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="inline-block bg-gradient-to-r from-copper to-sand text-navy font-bold px-8 py-4 rounded-xl hover:shadow-lg transition-all duration-300 mr-4"
                  >
                    Ouvrir Calendly
                  </a>
                  <a 
                    href="/contact" 
                    className="inline-block bg-navy border border-copper text-copper font-bold px-8 py-4 rounded-xl hover:bg-copper hover:text-navy transition-all duration-300"
                  >
                    Formulaire de Contact
                  </a>
                </div>
                <div className="mt-6 text-sm text-gray-400">
                  <p>📧 Email : globalstratelink@gmail.com</p>
                  <p>📱 WhatsApp : +971 54 319 2348</p>
                </div>
              </div>
            </div>
          </motion.div>
