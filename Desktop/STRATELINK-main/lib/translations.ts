export const translations = {
  en: {
    ...
    whyChooseUsTitle: "Why Choose Stratelink Global",
    whyChooseUsSubtitle: "Excellence at the service of your growth.",
    whyChooseUsDescription: "Discover what distinguishes us in the world of commercial and strategic development",
  ...
  fr: {
    ...
    whyChooseUsTitle: "Pourquoi choisir Stratelink Global",
    whyChooseUsSubtitle: "L'excellence au service de votre croissance.",
    whyChooseUsDescription: "Découvrez ce qui nous distingue dans l'univers du développement commercial et stratégique",
